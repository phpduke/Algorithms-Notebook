...
[1] Dinics Algo. FASTFLOW on SPOJ , 0.14s --marioyc
[2] Ford Fulkerson. only class included. div2ESoldiers on CF --Balaji Bombay (TLE on FASTFLOW ofc)

*/
///////////////////////////////////////

//[1]
// FASTFLOW on SPOJ : 0.14
// https://github.com/marioyc/Online-Judge-Solutions/blob/master/SPOJ/Classical/4110%20-%20Fast%20Maximum%20Flow.cpp
struct flow_graph{
...
class SimpleMaxFlow {
    ...
    /*void disp() {
        ...
        for(int i = 0; i < n; ++i) for(int j = 0; j < n; ++j) if(initial_cap[i][j] > 0) {
            cerr << i << " " << j << " " << cap[i][j] << "/" << initial_cap[i][j] << endl;
        }
        cerr << endl;
    }*/
};
